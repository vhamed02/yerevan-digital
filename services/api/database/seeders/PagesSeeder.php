    ...
    public function run(): void
    {
        $pages = [
            [
                ...
                'content' => [
                    'hy' => "Vendorex-ն հայկական բիզնեսների համար ստեղծված առցանց խանութի հարթակ է:\n\nՄեր առաքելությունն է հնարավոր դարձնել, որ ցանկացած հայ ձեռներեց կարողանա հեշտությամբ ստեղծել և վարել իր առցանց խանութը:\n\nՄենք հավատում ենք, որ թվային առևտուրը պետք է հասանելի լինի բոլոր բիզնեսների համար՝ անկախ չափից կամ տեխնիկական փորձից:\n\nVendorex-ն ապահովում է ամեն ինչ՝ ապրանքների կառավարում, հայկական վճարային համակարգեր, գեղեցիկ ձևանմուշներ և հեշտ օգտագործման վահանակ:",
                    'en' => "Vendorex is an online store platform built specifically for Armenian businesses.\n\nOur mission is to empower every Armenian entrepreneur to easily create and run their own online store.\n\nWe believe digital commerce should be accessible to all businesses, regardless of size or technical experience.\n\nVendorex provides everything you need — product management, Armenian payment systems, beautiful templates, and an easy-to-use dashboard.",
                ],
                'meta_title'       => ['hy' => 'Մեր Մասին — Vendorex', 'en' => 'About Us — Vendorex'],
                'meta_description' => [
                    'hy' => 'Ծանոթացեք Vendorex-ի հետ. հայկական բիզնեսների համար ստեղծված առցանց խանութի հարթակ:',
                    'en' => 'Learn about Vendorex — the online store platform built for Armenian businesses.',
                ],
            ],
            [
                'slug'    => 'contact',
                ...
                'meta_title'       => ['hy' => 'Կապ — Vendorex', 'en' => 'Contact Us — Vendorex'],
                'meta_description' => [
                    'hy' => 'Կապ հաստատեք Vendorex-ի աջակցության թիմի հետ:',
                    'en' => 'Get in touch with the Vendorex support team.',
                ],
            ],
            [
                'slug'    => 'terms',
                ...
                'content' => [
                    'hy' => "Օգտագործման Պայմաններ\n\nVendorex հարթակն օգտագործելով՝ Դուք համաձայնվում եք սույն պայմաններին:\n\n1. Գրանցում\nՕգտատերերը պարտավոր են ներկայացնել ճշգրիտ տեղեկատվություն գրանցման ժամանակ: Մեկ օգտատիրոջ համար թույլատրվում է մեկ հաշիվ:\n\n2. Արտոնագրային Իրավունքներ\nVendorex-ի բոլոր բովանդակությունն ու ծրագրային ապահովումը պաշտպանված է հեղինակային իրավունքով:\n\n3. Արգելված Գործողություններ\nՀարթակի չարաշահումը, կեղծ ապրանքների վաճառքը կամ խաբեությունն արգելված է:\n\n4. Պատասխանատվության Սահմանափակում\nVendorex-ն պատասխանատու չէ երրորդ կողմի ծառայություններից բխող կորուստների համար:",
                    'en' => "Terms of Use\n\nBy using the Vendorex platform, you agree to these terms.\n\n1. Registration\nUsers must provide accurate information during registration. One account per user is permitted.\n\n2. Intellectual Property\nAll content and software on Vendorex is protected by copyright.\n\n3. Prohibited Activities\nMisuse of the platform, sale of counterfeit goods, or fraud is strictly prohibited.\n\n4. Limitation of Liability\nVendorex is not responsible for losses arising from third-party services.",
                ],
                'meta_title'       => ['hy' => 'Օգտագործման Պայմաններ — Vendorex', 'en' => 'Terms of Use — Vendorex'],
                'meta_description' => [
                    'hy' => 'Կարդացեք Vendorex հարթակի օգտագործման պայմանները:',
                    'en' => 'Read the Terms of Use for the Vendorex platform.',
                ],
            ],
            [
                'slug'    => 'privacy',
